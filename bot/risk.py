...
_TIERS = [
    ...
    (0.90, 0.9499, 10, 0.09, 0.030, "limit", -0.0035, 3),
    (0.80, 0.8999, 7, 0.07, 0.025, "limit", -0.0050, 10),
    (0.70, 0.7999, 5, 0.05, 0.020, "limit", -0.0100, 10),
    (0.60, 0.6999, 3, 0.03, 0.015, "limit", -0.0150, 15),
]
